...
const Navbar_vue_vue_type_style_index_0_scoped_35396ee0_lang$1 = "a.router-link-active[data-v-35396ee0]{font-weight:700}a.router-link-exact-active[data-v-35396ee0]{color:var(--vegas-gold)}";
...
const __default__ = {
  ...
  methods: {
    ...
    getRepos() {
      axios.get("https://api.github.com/users/az-zamani/repos").then((res) => {
...
const _imports_1 = "" + __buildAssetsURL("kampusmadu1.0c6dfded.png");
const _sfc_main$a = {
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${ssrRenderAttrs(mergeProps({
        class: "about active",
        "data-page": "about"
      }, _attrs))}><section class="about-text"><ul class="about-list"><!--[-->`);
      ...
      _push(`<!--]--></ul></section><div class="${ssrRenderClass([{ active: unref(activeModal) }, "modal-container"])}"><div style="${ssrRenderStyle(unref(activeModal) ? null : { display: "none" })}" class="${ssrRenderClass([{ active: unref(activeOverlay) }, "overlay"])}"></div><section class="testimonials-modal"><button class="modal-close-btn"><ion-icon name="close-outline"></ion-icon></button><div class="flex gap-5 mb-5 justify-start items-center"><div class="modal-avatar-box"><img${ssrRenderAttr("src", unref(testimonialItem).image)} alt="Daniel lewis" width="80"></div><div class="modal-content"><h4 class="h3 modal-title">${ssrInterpolate(unref(testimonialItem).title)}</h4><time datetime="2021-06-14">14 June, 2021</time></div></div><div class="flex gap-5 items-start"><img class="my-auto hidden md:block"${ssrRenderAttr("src", _imports_0$1)} alt="quote icon"><p class="text-justify text-gray-400 text-sm md:text-md">${unref(locale) === "en" ? (_a = unref(testimonialItem).content) == null ? void 0 : _a.en : (_b = unref(testimonialItem).content) == null ? void 0 : _b.id_ID}</p></div><div class="mt-2 flex justify-end text-sm text-gray-600 italic"> Company Co. </div></section></div><section class="clients"><h3 class="h3 clients-title"> Clients </h3><ul class="clients-list has-scrollbar"><li class="clients-item"><a href="https://kampusmadu.com" target="_blank"><img${ssrRenderAttr("src", _imports_1)} alt="Company"></a></li></ul></section></article>`);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<article${ssrRenderAttrs(mergeProps({
        class: "resume active",
        "data-page": "resume"
      }, _attrs))}><header><h2 class="h2 article-title">${ssrInterpolate(_ctx.$t("pageTitles.resume"))}</h2></header><section class="timeline"><ol class="timeline-list"><li class="timeline-item"><h4 class="h4 timeline-item-title"> Kampusmadu </h4><span>2021</span><p class="timeline-item-desc"> Jumapolo, Karanganyar </p><p class="timeline-text"> Graphic Design </p></li></ol></section><section class="skill"><ul class="skills-list content-card"><li class="skills-item"><div class="title-wrapper"><h5 class="h5"> Web Development </h5><data value="40"></data></div><div class="skill-progress-bg"><div class="skill-progress-fill" style="${ssrRenderStyle({ "width": "100%" })}"></div></div></li><li class="skills-item"><div class="title-wrapper"><h5 class="h5"> Graphic Design </h5><data value="40"></data></div><div class="skill-progress-bg"><div class="skill-progress-fill" style="${ssrRenderStyle({ "width": "100%" })}"></div></div></li><li class="skills-item"><div class="title-wrapper"><h5 class="h5"> English </h5><data value="40"></data></div><div class="skill-progress-bg"><div class="skill-progress-fill" style="${ssrRenderStyle({ "width": "100%" })}"></div></div></li></ul></section></article>`);
    };
  }
};
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="sidebar-info"><figure class="avatar-box"><img${ssrRenderAttr("src", _imports_0)} alt="Photo" width="80"></figure><div class="info-content"><h6 class="text-lg font-bold dark:text-white" title="Ahmad Zakky Zamani"> Ahmad Zakky Zamani </h6><p class="title text-center xl:block flex items-center justify-center gap-1"><span>Mahasiswa Informatika</span></p></div><button class="info_more-btn"><span>Show Contacts</span><ion-icon name="chevron-down"></ion-icon></button></div><div class="sidebar-info_more"><div class="separator"></div><ul class="contacts-list"><li class="contact-item"><div class="icon-box"><ion-icon name="logo-instagram"></ion-icon></div><div class="contact-info"><p class="contact-title"> Instagram </p><a href="https://www.instagram.com/az_zamani_" class="contact-link" target="_blank">az_zamani_</a></div></li><li class="contact-item"><div class="icon-box"><ion-icon name="logo-github"></ion-icon></div><div class="contact-info"><p class="contact-title"> Github </p><a href="https://github.com/az-zamani" class="contact-link" target="_blank">az-zamani</a></div></li><li class="contact-item"><div class="icon-box"><ion-icon name="location-outline"></ion-icon></div><div class="contact-info"><p class="contact-title"> Location </p><address>Indonesia</address></div></li></ul><div class="separator"></div><ul class="social-list"><li class="social-item">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "mailto:azacky302@gmail.com",
        class: "social-link",
        target: "_blank"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$3;
  _push(`<nav${ssrRenderAttrs(mergeProps({ class: "navbar" }, _attrs))} data-v-35396ee0><ul class="navbar-list" data-v-35396ee0><li class="navbar-item" data-v-35396ee0>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "navbar-link"
  }, {
  ...
  _push(`</li><li class="navbar-item" data-v-35396ee0>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/resume",
    class: "navbar-link"
  }, {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-35396ee0"]]);
  ...
  setup(__props) {
    ...
    useHead({
      ...
      titleTemplate: (pageTitle) => {
        return pageTitle ? `${pageTitle} - Ahmad Zakky Zamani ` : "Ahmad Zakky Zamani";
      },
      meta: [
        { charset: "utf-8" },
...
export { CookieBar_vue_vue_type_style_index_0_scoped_f0d3c715_lang$1 as C, LoadingPage_vue_vue_type_style_index_0_scoped_4911785a_lang as L, Navbar_vue_vue_type_style_index_0_scoped_35396ee0_lang$1 as N, app_vue_vue_type_style_index_0_lang as a, error404_vue_vue_type_style_index_0_scoped_30d2164e_lang$1 as b, LangSwitcher2_vue_vue_type_style_index_0_scoped_c3fa5f4c_lang$1 as c, entry$1 as default, error500_vue_vue_type_style_index_0_scoped_32388612_lang$1 as e, flicking$1 as f, style as s, tailwind as t };
